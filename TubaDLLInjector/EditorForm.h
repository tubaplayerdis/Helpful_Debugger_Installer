...
namespace TubaDLLInjector {
	...
	protected:
	public: System::Windows::Forms::RichTextBox^ Editbox;
	private:
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Text = L"Toggle Bold";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &EditorForm::button1_Click);
			// 
			// Editbox
			// 
			this->Editbox->Location = System::Drawing::Point(12, 60);
			this->Editbox->Name = L"Editbox";
			this->Editbox->Size = System::Drawing::Size(1125, 570);
			...
			this->ClientSize = System::Drawing::Size(1149, 642);
